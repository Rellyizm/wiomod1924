...
await message.reply({embeds: [embed.setDescription(`${member}, Adlı kullanıcının ismi \`${member.displayName}\` olarak değiştirildi!`)]}).sil(7)
 }).catch(e => {});
   
};
exports.config = {
    name: "isim",
    usage: `${ayarlar.BotPrefix}isim [@Relly/ID] (Name) (Age)`,
    guildOnly: true,
    aliases: ["name","i"],
    cooldown: 3000
};