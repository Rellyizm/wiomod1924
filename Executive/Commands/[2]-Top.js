...
message.reply({embeds: [embed.setAuthor({name: message.guild.name, iconURL: message.guild.iconURL({dynamic: true})}).setDescription(`Sunucuya ait ilk 15 kayıt verisi; \n\n${top}`)]})
};
exports.config = {
    name: "topteyit",
    usage: `${ayarlar.BotPrefix}topteyit `,
        guildOnly: true,
    aliases: ["topteyit"],
    cooldown: 3000
};